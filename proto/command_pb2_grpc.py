...
class StatsServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetUsersStats = channel.unary_unary(
                ...
                request_serializer=command__pb2.GetUsersStatsRequest.SerializeToString,
                response_deserializer=command__pb2.GetUsersStatsResponse.FromString,
                _registered_method=True)
...
def add_StatsServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetUsersStats': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=command__pb2.GetUsersStatsRequest.FromString,
                    response_serializer=command__pb2.GetUsersStatsResponse.SerializeToString,
            ),
    }
...
class StatsService(object):
    ...
    def GetUsersStats(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/xray.app.stats.command.StatsService/GetUsersStats',
            command__pb2.GetUsersStatsRequest.SerializeToString,
            command__pb2.GetUsersStatsResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
